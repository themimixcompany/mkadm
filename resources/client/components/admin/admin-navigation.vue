                    ...
                    v-card(flat, style='border-radius: 0 4px 4px 0;')
                      template(v-if='current.kind === "link"')
                        ...
                        v-card-text
                          ...
                          .caption.pt-3.pl-5 The default icon set is #[strong Font Awesome 6]. In order to use another icon set, you must first select it in the Theme administration section.
                          .caption.pt-3.pl-5: strong Font Awesome 6
                          .caption.pl-5 Refer to the #[a(href='https://fontawesome.com/icons?d=gallery', target='_blank') Font Awesome 6 Reference] for the list of all possible values. You must prefix all values with #[code fas fa-], e.g. #[code fas fa-home]. Note that some icons use different prefixes (e.g. #[code fab], #[code fad], #[code fal], #[code far]).
